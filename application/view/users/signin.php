                    ...
                    <div class="panel-body">
                        <form method="POST" action="#" role="form">
                            ...
                            <div class="shape-group">
                                ...
                                <input name="idusername" type="email" maxlength="50" autocomplete="off" class="form-control">
                            </div>
                            <div class="shape-group">
                                <strong>Password</strong>
                                <input name="password" type="password" maxlength="25" autocomplete="off" class="form-control">
                            </div>
