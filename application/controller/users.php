    ...
    public function addUser() {
        if (isset($_POST['submit_add_user'])) {
            ...
            if ($file != null && getimagesize($file)) {
                ...
                $this->db_model->addUserWithImage($_POST["student_id"], $_POST["username"], $_POST["email"], $_POST["password"], $image);
            } else {
                // add user to database without image (default image used instead)
                $this->db_model->addUser($_POST["student_id"], $_POST["username"], $_POST["email"], $_POST["password"]);
            }
